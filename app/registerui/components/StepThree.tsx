...
export const ProfessionalInfoForm = ({ updateFormData, formData }: ProfessionalInfoFormProps) => {
        ...
        <div>
          ...
          >
            <Input
              ...
              inputMode="numeric"
              pattern="[0-9]*"
              suffix={<Icon icon="fluent:clock-bill-16-filled" height={24} className="text-zinc-400" />}
              className="h-14"
          ...
          >
            <Input
              ...
              pattern="[0-9]*"
              suffix={<Icon icon="mingcute:bank-card-fill" height={24} className="text-zinc-400" />}
              className="h-14"
