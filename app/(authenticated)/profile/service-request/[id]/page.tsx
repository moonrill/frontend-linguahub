          ...
          {serviceRequest?.notes && (
            <section className='flex flex-col gap-2 border p-4 rounded-lg'>
              ...
              <div className='flex gap-1'>
                ...
                />
                <p className='text-sm font-medium'>{serviceRequest?.notes}</p>
              </div>
            </section>
          )}
            ...
            <section className='flex flex-col gap-2 border p-4 rounded-lg'>
              ...
              <div className='flex justify-between'>
                <div className='flex gap-3'>
                  ...
                  <div className='flex flex-col justify-between'>
                    <p className='text-base font-semibold'>12 % OFF</p>
                    <p className='text-sm font-medium'>Summer Sale</p>
                  </div>
                </div>
                <p className='text-sm text-rose-600'>Exp: 27 Sept 2024</p>
              </div>
            </section>
          )}
          <section className='flex flex-col gap-2 border p-4 rounded-lg'>
